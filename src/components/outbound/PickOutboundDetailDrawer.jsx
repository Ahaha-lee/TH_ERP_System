...
const PickOutboundDetailDrawer = ({ open, onClose, orderId }) => {
  ...
  if (!order) {
    return (
      <Drawer forceRender title="领料出库详情" size="large" onClose={onClose} open={open}>
...
export default PickOutboundDetailDrawer;
