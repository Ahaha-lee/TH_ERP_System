...
const ProductionInboundDetailDrawer = ({ open, onClose, orderNo }) => {
  ...
  const columns = [
    ...
    { title: '本次入库数量', dataIndex: 'quantity', width: 110, align: 'right' },
...
export default ProductionInboundDetailDrawer;
