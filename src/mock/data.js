...
const initialState = {
  ...
  deliveryNotices: [
    ...
    { 
      id: 'dn-rej-1', 
      noticeNo: 'FH20260601001', 
      orderNo: 'SOD-20260601-0111', 
      customerName: '罗莱生活百货', 
      status: '已拒绝', 
      settlementMethod: '月结',
      approvalStatus: '审批拒绝',
      ...
      region: '华中大区',
      items: [
        { id: 'dni-rej1', productCode: 'PROD003', productName: '简约双人床', spec: '1.8m/灰色', orderQty: 10, shippedQty: 0, currentQty: 5, unitPrice: 2500, amount: 12500 }
      ],
      financeAuditResult: '拒绝',
      financeAuditor: '财务主管',
      financeAuditTime: '2026-06-01 14:00:00',
      financeAuditRemark: '该客户存在多笔逾期账款，拒绝发货申请。'
    },
    { 
      id: 'dn-ret-1', 
      noticeNo: 'FH20260605001', 
      orderNo: 'SOD-20260605-0222', 
      customerName: '宜家家居', 
      status: '财务审批', 
      settlementMethod: '现结',
      approvalStatus: '审批退回',
      ...
      region: '华东大区',
      items: [
        { id: 'dni-ret1', productCode: 'PROD004', productName: '多功能置物架', spec: '五层/金属色', orderQty: 20, shippedQty: 0, currentQty: 12, unitPrice: 400, amount: 4800 }
      ],
      financeAuditResult: '退回',
      financeAuditor: '财务主管',
      financeAuditTime: '2026-06-05 15:20:00',
      financeAuditRemark: '上传的付款凭证模糊不清，请重新拍照上传。'
    }
  ],
  flows: [
    { 
